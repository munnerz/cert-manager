...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CertificateFormat) DeepCopyInto(out *CertificateFormat) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertificateFormat.
func (in *CertificateFormat) DeepCopy() *CertificateFormat {
	if in == nil {
		return nil
	}
	out := new(CertificateFormat)
	in.DeepCopyInto(out)
	return out
}
