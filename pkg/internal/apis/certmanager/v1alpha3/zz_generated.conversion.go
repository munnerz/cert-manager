...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha3.CertificateFormat)(nil), (*certmanager.CertificateFormat)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_CertificateFormat_To_certmanager_CertificateFormat(a.(*v1alpha3.CertificateFormat), b.(*certmanager.CertificateFormat), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*certmanager.CertificateFormat)(nil), (*v1alpha3.CertificateFormat)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_certmanager_CertificateFormat_To_v1alpha3_CertificateFormat(a.(*certmanager.CertificateFormat), b.(*v1alpha3.CertificateFormat), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha3.PrivateKeyConfig)(nil), (*certmanager.PrivateKeyConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_PrivateKeyConfig_To_certmanager_PrivateKeyConfig(a.(*v1alpha3.PrivateKeyConfig), b.(*certmanager.PrivateKeyConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*certmanager.PrivateKeyConfig)(nil), (*v1alpha3.PrivateKeyConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_certmanager_PrivateKeyConfig_To_v1alpha3_PrivateKeyConfig(a.(*certmanager.PrivateKeyConfig), b.(*v1alpha3.PrivateKeyConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_CertificateFormat_To_certmanager_CertificateFormat(in *v1alpha3.CertificateFormat, out *certmanager.CertificateFormat, s conversion.Scope) error {
	out.Type = certmanager.CertificateFormatType(in.Type)
	return nil
}

// Convert_v1alpha3_CertificateFormat_To_certmanager_CertificateFormat is an autogenerated conversion function.
func Convert_v1alpha3_CertificateFormat_To_certmanager_CertificateFormat(in *v1alpha3.CertificateFormat, out *certmanager.CertificateFormat, s conversion.Scope) error {
	return autoConvert_v1alpha3_CertificateFormat_To_certmanager_CertificateFormat(in, out, s)
}

func autoConvert_certmanager_CertificateFormat_To_v1alpha3_CertificateFormat(in *certmanager.CertificateFormat, out *v1alpha3.CertificateFormat, s conversion.Scope) error {
	out.Type = v1alpha3.CertificateFormatType(in.Type)
	return nil
}

// Convert_certmanager_CertificateFormat_To_v1alpha3_CertificateFormat is an autogenerated conversion function.
func Convert_certmanager_CertificateFormat_To_v1alpha3_CertificateFormat(in *certmanager.CertificateFormat, out *v1alpha3.CertificateFormat, s conversion.Scope) error {
	return autoConvert_certmanager_CertificateFormat_To_v1alpha3_CertificateFormat(in, out, s)
}
...
func autoConvert_v1alpha3_CertificateSpec_To_certmanager_CertificateSpec(in *v1alpha3.CertificateSpec, out *certmanager.CertificateSpec, s conversion.Scope) error {
	...
	if err := Convert_v1alpha3_PrivateKeyConfig_To_certmanager_PrivateKeyConfig(&in.PrivateKey, &out.PrivateKey, s); err != nil {
		return err
	}
	if err := Convert_v1alpha3_CertificateFormat_To_certmanager_CertificateFormat(&in.Format, &out.Format, s); err != nil {
		return err
	}
...
func autoConvert_certmanager_CertificateSpec_To_v1alpha3_CertificateSpec(in *certmanager.CertificateSpec, out *v1alpha3.CertificateSpec, s conversion.Scope) error {
	...
	if err := Convert_certmanager_PrivateKeyConfig_To_v1alpha3_PrivateKeyConfig(&in.PrivateKey, &out.PrivateKey, s); err != nil {
		return err
	}
	if err := Convert_certmanager_CertificateFormat_To_v1alpha3_CertificateFormat(&in.Format, &out.Format, s); err != nil {
		return err
	}
	out.CommonName = in.CommonName
	out.Duration = (*v1.Duration)(unsafe.Pointer(in.Duration))
...
func autoConvert_v1alpha3_PrivateKeyConfig_To_certmanager_PrivateKeyConfig(in *v1alpha3.PrivateKeyConfig, out *certmanager.PrivateKeyConfig, s conversion.Scope) error {
	out.Size = in.Size
	out.Algorithm = certmanager.KeyAlgorithm(in.Algorithm)
	return nil
}

// Convert_v1alpha3_PrivateKeyConfig_To_certmanager_PrivateKeyConfig is an autogenerated conversion function.
func Convert_v1alpha3_PrivateKeyConfig_To_certmanager_PrivateKeyConfig(in *v1alpha3.PrivateKeyConfig, out *certmanager.PrivateKeyConfig, s conversion.Scope) error {
	return autoConvert_v1alpha3_PrivateKeyConfig_To_certmanager_PrivateKeyConfig(in, out, s)
}

func autoConvert_certmanager_PrivateKeyConfig_To_v1alpha3_PrivateKeyConfig(in *certmanager.PrivateKeyConfig, out *v1alpha3.PrivateKeyConfig, s conversion.Scope) error {
	out.Size = in.Size
	out.Algorithm = v1alpha3.KeyAlgorithm(in.Algorithm)
	return nil
}

// Convert_certmanager_PrivateKeyConfig_To_v1alpha3_PrivateKeyConfig is an autogenerated conversion function.
func Convert_certmanager_PrivateKeyConfig_To_v1alpha3_PrivateKeyConfig(in *certmanager.PrivateKeyConfig, out *v1alpha3.PrivateKeyConfig, s conversion.Scope) error {
	return autoConvert_certmanager_PrivateKeyConfig_To_v1alpha3_PrivateKeyConfig(in, out, s)
}
