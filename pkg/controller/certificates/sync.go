...
func (c *controller) Sync(ctx context.Context, crt *v1alpha1.Certificate) (err error) {
	...
	defer func() {
		if _, saveErr := updateCertificateStatus(ctx, c.cmClient, crt, crtCopy); saveErr != nil {
...
func updateCertificateStatus(ctx context.Context, cmClient cmclient.Interface, old, new *v1alpha1.Certificate) (*v1alpha1.Certificate, error) {
