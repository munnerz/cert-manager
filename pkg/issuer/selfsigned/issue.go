...
func (c *SelfSigned) obtainCertificate(crt *v1alpha1.Certificate, privateKey *rsa.PrivateKey) ([]byte, error) {
	...
	crtPem, _, err := signCertificate(crt, privateKey, publicKey)
	if err != nil {
		return nil, err
	}
...
// signCertificate returns a self signed x509.Certificate object for the given
// *v1alpha1.Certificate crt.
func signCertificate(crt *v1alpha1.Certificate, privateKey interface{}, publicKey interface{}) ([]byte, *x509.Certificate, error) {
