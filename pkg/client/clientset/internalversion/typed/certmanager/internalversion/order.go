...
type OrderInterface interface {
	Create(*certmanager.Order) (*certmanager.Order, error)
	Update(*certmanager.Order) (*certmanager.Order, error)
	UpdateStatus(*certmanager.Order) (*certmanager.Order, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*certmanager.Order, error)
	List(opts v1.ListOptions) (*certmanager.OrderList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *certmanager.Order, err error)
	OrderExpansion
}
...
func newOrders(c *CertmanagerClient, namespace string) *orders {
	return &orders{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *orders) Get(name string, options v1.GetOptions) (result *certmanager.Order, err error) {
	result = &certmanager.Order{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("orders").
		Name(name).
...
func (c *orders) List(opts v1.ListOptions) (result *certmanager.OrderList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &certmanager.OrderList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("orders").
...
func (c *orders) Create(order *certmanager.Order) (result *certmanager.Order, err error) {
	result = &certmanager.Order{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("orders").
...
func (c *orders) Update(order *certmanager.Order) (result *certmanager.Order, err error) {
	result = &certmanager.Order{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("orders").
...
func (c *orders) UpdateStatus(order *certmanager.Order) (result *certmanager.Order, err error) {
	result = &certmanager.Order{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("orders").
...
func (c *orders) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *certmanager.Order, err error) {
	result = &certmanager.Order{}
