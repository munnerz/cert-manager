...
type ChallengeInterface interface {
	Create(*certmanager.Challenge) (*certmanager.Challenge, error)
	Update(*certmanager.Challenge) (*certmanager.Challenge, error)
	UpdateStatus(*certmanager.Challenge) (*certmanager.Challenge, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*certmanager.Challenge, error)
	List(opts v1.ListOptions) (*certmanager.ChallengeList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *certmanager.Challenge, err error)
	ChallengeExpansion
}
...
func newChallenges(c *CertmanagerClient, namespace string) *challenges {
	return &challenges{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *challenges) Get(name string, options v1.GetOptions) (result *certmanager.Challenge, err error) {
	result = &certmanager.Challenge{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("challenges").
		Name(name).
...
func (c *challenges) List(opts v1.ListOptions) (result *certmanager.ChallengeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &certmanager.ChallengeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("challenges").
...
func (c *challenges) Create(challenge *certmanager.Challenge) (result *certmanager.Challenge, err error) {
	result = &certmanager.Challenge{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("challenges").
...
func (c *challenges) Update(challenge *certmanager.Challenge) (result *certmanager.Challenge, err error) {
	result = &certmanager.Challenge{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("challenges").
...
func (c *challenges) UpdateStatus(challenge *certmanager.Challenge) (result *certmanager.Challenge, err error) {
	result = &certmanager.Challenge{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("challenges").
...
func (c *challenges) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *certmanager.Challenge, err error) {
	result = &certmanager.Challenge{}
