...
import (
	"github.com/jetstack/cert-manager/pkg/client/clientset/internalversion/scheme"
...
func (c *CertmanagerClient) CertificateRequests(namespace string) CertificateRequestInterface {
	return newCertificateRequests(c, namespace)
}

func (c *CertmanagerClient) Challenges(namespace string) ChallengeInterface {
	return newChallenges(c, namespace)
}

func (c *CertmanagerClient) ClusterIssuers() ClusterIssuerInterface {
...
func (c *CertmanagerClient) Orders(namespace string) OrderInterface {
...
func setConfigDefaults(config *rest.Config) error {
	...
	if config.GroupVersion == nil || config.GroupVersion.Group != scheme.Scheme.PrioritizedVersionsForGroup("certmanager.k8s.io")[0].Group {
		gv := scheme.Scheme.PrioritizedVersionsForGroup("certmanager.k8s.io")[0]
