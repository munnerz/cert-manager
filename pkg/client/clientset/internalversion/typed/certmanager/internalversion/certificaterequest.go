...
import (
	...
	scheme "github.com/jetstack/cert-manager/pkg/client/clientset/internalversion/scheme"
...
type CertificateRequestInterface interface {
	Create(*certmanager.CertificateRequest) (*certmanager.CertificateRequest, error)
	Update(*certmanager.CertificateRequest) (*certmanager.CertificateRequest, error)
	UpdateStatus(*certmanager.CertificateRequest) (*certmanager.CertificateRequest, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*certmanager.CertificateRequest, error)
	List(opts v1.ListOptions) (*certmanager.CertificateRequestList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *certmanager.CertificateRequest, err error)
...
func newCertificateRequests(c *CertmanagerClient, namespace string) *certificateRequests {
...
func (c *certificateRequests) Get(name string, options v1.GetOptions) (result *certmanager.CertificateRequest, err error) {
	result = &certmanager.CertificateRequest{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *certificateRequests) List(opts v1.ListOptions) (result *certmanager.CertificateRequestList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &certmanager.CertificateRequestList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("certificaterequests").
...
func (c *certificateRequests) Create(certificateRequest *certmanager.CertificateRequest) (result *certmanager.CertificateRequest, err error) {
	result = &certmanager.CertificateRequest{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("certificaterequests").
...
func (c *certificateRequests) Update(certificateRequest *certmanager.CertificateRequest) (result *certmanager.CertificateRequest, err error) {
	result = &certmanager.CertificateRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("certificaterequests").
...
func (c *certificateRequests) UpdateStatus(certificateRequest *certmanager.CertificateRequest) (result *certmanager.CertificateRequest, err error) {
	result = &certmanager.CertificateRequest{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("certificaterequests").
...
func (c *certificateRequests) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *certmanager.CertificateRequest, err error) {
	result = &certmanager.CertificateRequest{}
