...
type ClusterIssuerInterface interface {
	Create(*certmanager.ClusterIssuer) (*certmanager.ClusterIssuer, error)
	Update(*certmanager.ClusterIssuer) (*certmanager.ClusterIssuer, error)
	UpdateStatus(*certmanager.ClusterIssuer) (*certmanager.ClusterIssuer, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*certmanager.ClusterIssuer, error)
	List(opts v1.ListOptions) (*certmanager.ClusterIssuerList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *certmanager.ClusterIssuer, err error)
...
func newClusterIssuers(c *CertmanagerClient) *clusterIssuers {
...
func (c *clusterIssuers) Get(name string, options v1.GetOptions) (result *certmanager.ClusterIssuer, err error) {
	result = &certmanager.ClusterIssuer{}
	err = c.client.Get().
...
func (c *clusterIssuers) List(opts v1.ListOptions) (result *certmanager.ClusterIssuerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &certmanager.ClusterIssuerList{}
	err = c.client.Get().
		Resource("clusterissuers").
...
func (c *clusterIssuers) Create(clusterIssuer *certmanager.ClusterIssuer) (result *certmanager.ClusterIssuer, err error) {
	result = &certmanager.ClusterIssuer{}
	err = c.client.Post().
		Resource("clusterissuers").
		Body(clusterIssuer).
...
func (c *clusterIssuers) Update(clusterIssuer *certmanager.ClusterIssuer) (result *certmanager.ClusterIssuer, err error) {
	result = &certmanager.ClusterIssuer{}
	err = c.client.Put().
		Resource("clusterissuers").
...
func (c *clusterIssuers) UpdateStatus(clusterIssuer *certmanager.ClusterIssuer) (result *certmanager.ClusterIssuer, err error) {
	result = &certmanager.ClusterIssuer{}
	err = c.client.Put().
		Resource("clusterissuers").
		Name(clusterIssuer.Name).
...
func (c *clusterIssuers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *certmanager.ClusterIssuer, err error) {
	result = &certmanager.ClusterIssuer{}
